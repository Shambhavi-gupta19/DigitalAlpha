...
print("Correlation between price_12pk and case_12pk")
print(np.corrcoef(price_12pk,case_12pk))
print("Correlation between price_18pk and case_18pk")
print(np.corrcoef(price_18pk,case_18pk))
print("Correlation between price_30pk and case_30pk")
print(np.corrcoef(price_30pk,case_30pk))
